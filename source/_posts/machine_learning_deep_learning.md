...
2. 递归向上回退，如果以x圆心，以“近似最近点”为半径的球与根节点的**另一半子区域**边界相交，则说明另一半子区域中存在与x更近的点，则进入另一个子区域中查找该点并且更新”近似最近点“
...
2. 可以很自然的引用**核函数**（拉格朗日表达式里面有内积，而核函数也是通过内积进行映射的）
