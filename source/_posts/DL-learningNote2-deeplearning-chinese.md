...
<img src="http://chart.googleapis.com/chart?cht=tx&chl=f(x)=x^{\top}A x" style="border:none;">，其中限制$$ \left \| x \right \|_2 = 1 $$，当$$x$$是$$A$$的特征值的时候，$f$将返回对应的特征值，f的**最大值是最大的特征值**，最小值是最小的特征值。
